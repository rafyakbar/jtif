                ...
                @foreach(\App\Menu::orderBy('nama')->get() as $item)
                    <form action="{{ route('edit.menu') }}" method="post">
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="submit" class="btn btn-pill-left btn-primary">Simpan</button>
                                <a href="" class="btn btn-info">Lihat post</a>
                                <button class="btn btn-pill-right btn-danger" onclick="event.preventDefault(); document.getElementById('{{ $item->id }}').submit();">
                                    Hapus
                                </button>
                            </td>
                        </tr>
